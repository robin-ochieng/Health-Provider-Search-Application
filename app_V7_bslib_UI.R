...
ui <- fluidPage(
  ...
  # Modal for welcoming message
  modalDialog(
    title = "Welcome to the Provider Search Portal",
    "This application helps you find medical providers based on your preffered location and specialty interactively. Use the filters to start your search.",
    easyClose = TRUE,
  ...
  titlePanel(
    div(
      img(src = "images/kenbright.png", class = "logo-image"),
    ...
    mainPanel(
      div(class = "card",
          div(class = "card-header",
              h5("Providers Map", class = "card-title")
          ),
          div(class = "card-body",
...
server <- function(input, output, session) {
  ...
  # Automatically show the modal when the app loads
